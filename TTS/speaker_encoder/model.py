...
class LSTMWithProjection(nn.Module):
    ...
    def forward(self, x):
        ...
        print('LSTMWithProjection forward')
        o, (_, _) = self.lstm(x)
...
class LSTMWithoutProjection(nn.Module):
    def __init__(self, input_dim, lstm_dim, proj_dim, num_lstm_layers):
        ...
        self.relu = nn.ReLU()
        print('LSTMWithoutProjection init')
    def forward(self, x):
        _, (hidden, _) = self.lstm(x)
        print('LSTMWithoutProjection forward')

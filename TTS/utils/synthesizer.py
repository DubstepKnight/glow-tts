...
class Synthesizer(object):
    ...
    def load_speakers(self):
        # load speakers
        if self.tts_config.use_speaker_embedding is not None:
    ...
    def init_speaker(self, speaker_idx):
        ...
        if hasattr(self, 'tts_speakers') and speaker_idx is not None:
            ...
            if self.tts_config.use_external_speaker_embedding_file:
                # print('self.tts_speakers[speaker_idx]: ', self.tts_speakers[speaker_idx])
                speaker_embedding = self.tts_speakers[str(speaker_idx)]['embedding']

...
parser.add_argument(
    '--map_location',
    type=bool,
    help='flag to set the map_location',
    default=False
)
parser.add_argument(
    'config_path',
...
print('the target dataset: ', args.target_dataset)
    ...
    dataset_config = [
        {
            ...
            "path": '/home/nurs/PycharmProjects/TTS/TTS/TTS/speaker_encoder/voice_samples',
...
speaker_mapping = {}
print('it should definitely print this')
for idx, wav_file in enumerate(tqdm(wav_files)):
    print('this is supposed to be inside in for loop')
